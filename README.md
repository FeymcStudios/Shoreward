...
# Sprint 3
## Product Backlog URL
https://miro.com/app/board/uXjVM17nlms=/

+ **Sprint Notları**: Bu sprintte oyunu tamamlamaya çalıştık fakat bitiremedik. Oyunu demo haliyle yüklemeye karar verdik.
+ **Sprint içinde tamamlanması tahmin edilen puan**: Bu sprint içinde tamamlanması tahmin edilen puan 225'tir.
+ **Puan tamamlama mantığı**: Proje boyunca tamamlanması tahmin edilen backloglara 400 puan verdik. İkinci sprint için 225 puanın tamamlanması gerektiğini düşündük. Çünkü geçen sprintten kalan 75 puanımız vardı. Ama bu sprintte belirlediğimiz backloglardan ''oyun tamamlama''yı bitiremediğimiz için 150 puan aldık.
+  **Backlog düzeni ve Story seçimleri**: Backlogumuz oyun tamamlama, level tasarımları ce karakter tasarımları üzerine kurulmuştur. Sprint başına tahmin edilen puan sayısını geçmeyecek şekilde sıradan seçimler yapılmaktadır.
+  **Daily Scrum**: Product Owner'ımız Mustafa Aydemir'in günlük faaliyetlerimizi raporladığı eylem takibi notları dosyadadır.

[Sprint 3 Daily Scrum.docx](https://github.com/FeymcStudios/Shoreward/files/12081562/Sprint.3.Daily.Scrum.docx)

+ **Sprint board**
  Ekran Görüntüsü
<img width="381" alt="sprint 3 sprint board" src="https://github.com/FeymcStudios/Shoreward/assets/127511311/ec215c33-e74c-4a32-817a-84659a13239b">

+ **Ürün Durumu**
  Ekran Görüntüsü:
![ts1](https://github.com/FeymcStudios/Shoreward/assets/127511311/17c2f604-7c0d-4846-959f-1f0b9ff0bf93)
![ts2](https://github.com/FeymcStudios/Shoreward/assets/127511311/76d576e9-2216-47ad-9cad-9ec644744209)

  ![ts3](https://github.com/FeymcStudios/Shoreward/assets/127511311/27f85f72-0f53-4a5e-9dab-0c7ed806ae80)

![ud 2](https://github.com/FeymcStudios/Shoreward/assets/127511311/ebc9e44c-fc5a-4c4c-b34d-34dd9482cb76)

![ud 3](https://github.com/FeymcStudios/Shoreward/assets/127511311/29a8c1c7-9e00-4b1d-9ca3-205691dd58e7)

 + **Sprint Review**: 

  Alınan kararlar: Oyunu bitirmediğimiz için demo halini paylaşmaya karar verdik.
   + **Sprint Review katılımcıları:** Mustafa Aydemir, Fatma Betül Tokuşlu, Cengizhan Boz, Ece Sütçü, Yaren Sarı

+ **Sprint Retrospective:** Oyunumuz desteklenmeye hak kazanırsa ekibi bozmadan çalışmalara devam edip oyunu bitirmeye karar verdik.
